...
ko.components.register('large-feature-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'large-feature-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Large Feature Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('small-feature-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'small-feature-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Small Feature Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('basic-story-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'basic-story-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Basic Story Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('extended-story-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'extended-story-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Extended Story Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('collection-grid-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'collection-grid-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Collection Grid Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('carousel-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'carousel-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Carousel Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('text-link-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'text-link-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Text Link Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('image-link-double-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'image-link-double-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Image Link Double Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('button-link-double-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'button-link-double-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'Button Link Double Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('seo-link-module', {
    ...
    template: `
        <li class="row module" data-bind="sortable: uniqueId, attr: { 'data-id': uniqueId, id: uniqueId, 'data-type': 'seo-link-module' }">
            <div class="flexContainer">
                <div class="small-11 columns">
                    <dl class="accordion" data-accordion="" role="tablist">
                        <dd class="accordion-navigation">
                            <a class="draggable" data-bind="text: 'SEO Links Module', attr: { href: '#accordion'+uniqueId, id: 'accordion-heading'+uniqueId, role: 'tab' }"></a>
...
ko.components.register('homePageTool', {
    ...
    template: `
        ...
        <ul data-bind="foreach: selectedModules()" id="sortableContainer">
